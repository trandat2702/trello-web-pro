...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMembers }) {
  ...
  //Đoạn này lấy activeBoard từ redux ra để mục đích là lấy được toàn bộ thông tin những thành viên cái board thông qua field: FE_allUsers
  const board = useSelector(selectCurrentActiveBoard)
  /**
    Thành viên trong card sẽ phải là tập con của thành viên trong board
    Vì thế dựa vào mảng board.FE_allUsers card.memberIds rồi
    chúng ta tạo ra 1 mảng FE_CardMembers chứa đủ thông tin của User để hiện thị ra ngoài giao diện(memberIds)
   */
