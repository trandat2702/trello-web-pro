...
function AutoCompleteSearchBoard() {
  ...
  const handleInputSearchChange = (event) => {
    ...
    fetchBoardsAPI(searchPath)
      ...
      .finally(() => {
        //dù có lỗi hay không thì cũng không hiện cái loading nữa
        setLoading(false)
      })
  }
  // Bọc hàm handleInputSearchChange vào useDebounceFn để tránh việc spam gọi API khi người dùng gõ chữ liên tục
